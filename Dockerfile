...
USER 1001
EXPOSE 7860
HEALTHCHECK --interval=30s --timeout=5s --start-period=20s --retries=3 CMD node -e "fetch('http://127.0.0.1:7860/api/health').then(r => { if (!r.ok) process.exit(1) }).catch(() => process.exit(1))"
